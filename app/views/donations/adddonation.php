                ...
                <form action="<?php echo URLROOT; ?>/requests/add" method="post">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control <?php echo (!empty($data['amount_err'])) ? 'is-invalid' : ''; ?>" placeholder="Amount or Estimated Amount" name="amount" value="<?php echo $data['amount'] ?>">
